...
const PLATFORMS: Platform[] = [
  { id: 'wechat',    icon: '💬', label: '公众号', desc: '图文推送' },
  { id: 'xiaohongshu', icon: '📕', label: '小红书', desc: '图文笔记' },
  { id: 'douyin',    icon: '🎵', label: '抖音',   desc: '短视频脚本' },
  { id: 'weibo',     icon: '🌐', label: '微博',   desc: '热点短文' },
  { id: 'shipinhao', icon: '📹', label: '视频号', desc: '竖版视频' },
  { id: 'zhihu',     icon: '❓', label: '知乎',   desc: '专业回答' },
];
